...
for network, classes in sub_networks.items():
    if network == 'Root':
        ...
        trainloader = torch.utils.data.DataLoader(root_dataset, batch_size=100, shuffle=True, num_workers=0)
        ...
        trainloader = torch.utils.data.DataLoader(filtered_trainset, batch_size=100, shuffle=True, num_workers=0)
