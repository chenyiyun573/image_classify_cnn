...
def train(rank, world_size):
    ...
    train_set = datasets.ImageFolder(root=train_dataset_path, transform=train_transforms)
    ...
    test_set = datasets.ImageFolder(root=val_dataset_path, transform=test_transforms)
