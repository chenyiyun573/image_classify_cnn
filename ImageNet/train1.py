...
def set_trainloader(Node: NetworkInfoNode):
    ...
    Node.trainloader = torch.utils.data.DataLoader(filtered_dataset, batch_size=256, shuffle=True, num_workers=2)
    ...
    if Node.children != []:
        for child in Node.children:
            ...
            child.trainloader = torch.utils.data.DataLoader(filtered_dataset, batch_size=256, shuffle=True, num_workers=2)
            """
